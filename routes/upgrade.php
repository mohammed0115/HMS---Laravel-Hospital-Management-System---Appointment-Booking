...
Route::get('/upgrade/database', function (){
    ...
    if(config('app.upgrade_mode')) {
        ...
        Artisan::call('migrate',
            [
                '--force' => true,
                '--path' => 'database/migrations/2022_08_26_225704_change_charges_standard_charge_column.php',
            ]);
        Artisan::call('migrate',
            [
                '--force' => true,
                '--path' => 'database/migrations/2022_08_30_011825_change_item_unit_column.php',
            ]);
        Artisan::call('migrate',
            [
                '--force' => true,
                '--path' => 'database/migrations/2022_09_08_201840_defalut_new_module_seeder.php',
            ]);   
    }
