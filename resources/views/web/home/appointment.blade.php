...
@section('content')
    ...
    <div class="appointment-page">
        ...
        <section class="appointment-section p-t-120 position-relative">
            <div class="container">
                {{ Form::open(['id' => 'webAppointmentForm','class'=>'appointment-form']) }}
        ...
        {{Form::hidden('appointmentSaveUrl',route('web.appointments.store'),['id'=>'homeAppointmentSaveUrl','class'=>'homeAppointmentSaveUrl'])}}
