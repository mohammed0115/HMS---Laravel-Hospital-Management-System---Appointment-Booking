...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="appointment-form__input-block">
            ...
            {{ Form::select('department_id',$departments, null, ['class' => 'doctor-name-filter ', 'id' => 'webDepartmentId', 'placeholder'=>Lang::get('messages.web_appointment.select_department'), 'required']) }}
        </div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="appointment-form__input-block">
            <label for="selectDoctor" class="form-label">{{__('messages.appointment.doctor')}} :<span
                        class="required">*</span></label>
            {{ Form::select('doctor_id',[], null, ['class' => 'selectized', 'autocomplete' => 'off', 'id' => 'appointmentDoctorId', 'placeholder'=>Lang::get('messages.web_appointment.select_doctor'), 'required']) }}
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="appointment-form__input-block">
    ...
    <div class="col-lg-12 text-center mt-4">
        <button type="submit" class="btn btn-primary custom-btn-lg" id="btnSave">{{__('messages.common.save')}}</button>
    </div>
</div>
