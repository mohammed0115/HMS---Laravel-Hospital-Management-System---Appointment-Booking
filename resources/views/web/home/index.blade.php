            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-lg-row">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="{{ !empty($frontSetting['home_page_image']) ? $frontSetting['home_page_image'] : asset('web_front/images/main-banner/banner-one/Home.png') }}" alt="Infy Care" class="img-fluid" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="appointment-section">
            <div class="container">
                <div class="book-appintment position-relative br-2 bg-white">
                    <form action="{{route('appointment.form')}}" class="book-appointment-form" method="POST">
                        @csrf
                        <div class="row align-items-center justify-content-around">
                            ...
                            <div class="col-lg-3 col-md-6 text-center mb-lg-0 mb-3">
                                <select class="doctor-name-filter" name="doctorId" aria-label="select doctor">
                            ...
                            <div class="col-lg-3 col-md-6 text-center mb-lg-0 mb-3">
                                <input type="text" name="appointmentDate" autocomplete="off" class="form-control"
                                       id="datepicker"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 position-relative">
                        <div class="certified-doctor  text-end">
                            <img src="{{ $frontSetting['home_page_certified_doctor_image'] }}" alt="Certifired Doctor" class="img-fluid">
                        </div>
