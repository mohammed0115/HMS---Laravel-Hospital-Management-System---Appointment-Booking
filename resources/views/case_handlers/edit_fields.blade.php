...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mobile-overlapping mb-5">
            ...
            <br>
            {{ Form::tel('phone', null, ['class' => 'form-control phoneNumber','id' => 'editCaseHandlerPhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'tabindex' => '5']) }}
