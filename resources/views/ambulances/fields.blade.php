<div class="row">
    ...
    <div class="form-group col-sm-6 mb-5">
        ...
        <span class="required"></span>
        <br>
        {{ Form::tel('driver_contact', null, ['class' => 'form-control phoneNumber','id' => 'ambulancePhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','required']) }}
