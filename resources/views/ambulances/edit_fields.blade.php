<div class="row">
    ...
    <div class="form-group col-sm-6 mb-5">
        ...
        <span class="required"></span>
        <br>
        {{ Form::tel('driver_contact', null, ['class' => 'form-control phoneNumber','id' => 'editAmbulancePhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','required']) }}
    ...
    <div class="form-group col-sm-6 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('vehicle_type', $type,null, ['id'=>'editAmbulanceVehicleType','class' => 'form-select','required','data-control' => 'select2']) }}
    </div>
    ...
    <div class="d-flex justify-content-end">
        {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary me-2 btnSave', 'id' => 'editAmbulanceBtnSave']) }}
