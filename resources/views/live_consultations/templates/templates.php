    ...
    {{/if}}
     ...
     {{if isDoctor || isAdmin}}
        {{if !isMeetingFinished}}
            <a href="javascript:void(0)" title="<?php echo __('messages.common.edit') ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-btn" data-id="{{:id}}">
