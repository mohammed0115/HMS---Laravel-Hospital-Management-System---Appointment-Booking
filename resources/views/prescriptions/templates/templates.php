...
<script id="prescriptionActionTemplate" type="text/x-jsrender">
    ...
    <a href="javascript:void(0)" data-id="{{:id}}" title="<?php echo __('messages.common.view') ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 show-btn">
<i class="fas fa-eye fs-4"></i>
</a>
    <a href="javascript:void(0)" title="<?php echo __('messages.common.delete') ?>" data-id={{:id}}" class="delete-btn btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
        <span class="svg-icon svg-icon-3">
