...
<table width="100%">
    ...
    <tr>
        <td colspan="2">
            <table width="100%">
                <tr>
                    <td colspan="2" class="font-weight-bold patient-detail-heading">{{ __('messages.patient.patient_details') }}</td>
                </tr>
                <tr>
        ...
        <td colspan="2">
            <table class="table number-align w-100" width="100%">
                ...
                <tr class="patient-detail-heading">
                    <th class="h5 font-weight-bold number-align" scope="col" colspan="4">{{ __('messages.bill.bill_summary') }}</th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td class="font-weight-bold">{{ ($bill['gross_total'] > 0) ? $bill['gross_total'] : 0  }}</td>
                </tr>
                <tr>
                    <td colspan="4" class="number-align">
