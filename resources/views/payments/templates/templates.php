...
<a href="javascript:void(0)" title="<?php echo __('messages.common.view') ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 show-btn" data-id={{:id}}">
