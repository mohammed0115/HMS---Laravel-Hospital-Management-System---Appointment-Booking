...
<!-- Package Id Field -->
    ...
    <div class="form-group mb-5 col-sm-6 mb-5">
        ...
        <br>
        {{ Form::text('guardian_contact', null, ['class' => 'form-control phoneNumber', 'id' => 'admissionPhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
