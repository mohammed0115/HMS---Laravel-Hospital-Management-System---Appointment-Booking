...
{{--                <div class="alert alert-danger display-none" id="editProfileValidationErrorsBox"></div>--}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6  mb-5">
                        {{ Form::label('phone', __('messages.profile.phone').':', ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::tel('phone', null, ['id'=>'phone', 'required','class' => 'form-control', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
                    </div>
                </div>
                <div class="row">
